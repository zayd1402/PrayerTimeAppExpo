...
This project is indexed by GitNexus as **PrayerTimeAppExpo** (754 symbols, 1173 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
