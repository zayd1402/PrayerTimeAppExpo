  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.infoGrid}>
        ...
        <View style={styles.infoCard}>
          <Ionicons name="location" size={20} color={C.emerald} />
...
const styles = StyleSheet.create({
  ...
  needleTop: { position: 'absolute', top: 0, width: 0, height: 0, borderLeftWidth: 12, borderRightWidth: 12, borderBottomWidth: 70, borderLeftColor: 'transparent', borderRightColor: 'transparent', borderBottomColor: C.emerald },
  ...
  needleCenter: { width: 36, height: 36, borderRadius: 18, backgroundColor: C.emerald, justifyContent: 'center', alignItems: 'center', zIndex: 10 },
  ...
  alignedBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: C.emerald, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, marginTop: 16 },
