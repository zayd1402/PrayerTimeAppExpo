            ...
            <>
              ...
              {charityRecords.slice().reverse().map(record => (
                <View key={record.id} style={styles.charityRecord}>
                  <View style={[styles.charityDot, { backgroundColor: record.category === 'zakat' ? C.emerald : record.category === 'sadaqah' ? '#E53935' : C.gold }]} />
...
const styles = StyleSheet.create({
  ...
  zakatLabel: { fontSize: 16, fontWeight: '700', color: C.emerald },
  zakatValue: { fontSize: 18, fontWeight: 'bold', color: C.emerald },
