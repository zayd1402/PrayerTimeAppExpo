      ...
      <>
        <View style={styles.dhikrHeader}>
          ...
          <View style={{ flexDirection: 'row', gap: 12 }}>
            ...
            <TouchableOpacity onPress={saveSession}><Text style={[styles.dhikrAction, { color: C.emerald }]}>Save</Text></TouchableOpacity>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  sunnahIconWrapDone: { backgroundColor: C.emerald },
  ...
  sunnahNameDone: { color: C.emerald },
  ...
  dhikrTotal: { fontSize: 56, fontWeight: 'bold', color: C.emerald },
  ...
  fastCardActive: { borderColor: C.emerald, backgroundColor: C.emeraldPale },
